...
const Services = () => {
  return (
    <div className="h-full bg-[#e0e0e0] py-24 px-6 sm:px-12 lg:px-24 pt-36 dark:text-white">
      ...
      <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {services.map((service, index) => (
          <motion.div
            key={index}
            className="bg-[#e0e0e0] text-gray-800 p-6 rounded-xl shadow-[8px_8px_16px_#bebebe,-8px_-8px_16px_#ffffff] hover:shadow-[inset_8px_8px_16px_#bebebe,inset_-8px_-8px_16px_#ffffff] transition duration-300 ease-in-out"
