...
const About = () => {
  return (
    <div className="min-h-screen bg-black py-12 px-6 md:px-24 pt-36 text-black">
      {/* Heading */}
          ...
          <div className="space-y-10">
            {educationTimeline.map((edu, index) => (
              ...
              >
                ...
                {/* Timeline Content */}
                <div
                  className={`bg-[#e0e0e0] w-full md:w-2/5 p-6 rounded-xl  shadow-[4px_4px_8px_#06b6d4,-4px_-4px_8px_#0891b2] ${
